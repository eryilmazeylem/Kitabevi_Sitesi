		...
		<div class="main-page-wrapper">
			...
			<section id="about-us">
				<div class="container">
					<div class="theme-title">
						<h1>HAKKIMIZDA</h1>
						<p>Hürkuş Sahaf ve Kitabevi olarak 2018 yılının şubat ayından beri aktif olarak hizmet vermekteyiz.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<p>Kitaplarımız siparişlerin ardından çok kısa bir sürede paket içinde kargoya verilmektedir.</p>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<p>Saat 15:00 'den verilen siparişler aynı gün içinde kargoya verilmektedir.</p>
			...
			<div id="service-section">
				<div class="container">
					<div class="theme-title">
						<h2>HİZMETLERİMİZ</h2>
						<p>7/24 sipariş ve çok hızlı kargo ile %99 müşteri memnuniyeti sağladığımız sitemizde satışlarımız devam etmektedir.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								...
								<p>Saat 15:00'den önce verilen tüm siparişler aynı gün kargoya çıkar. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								...
								<p>Şu ana kadar yaptığımız 3000 den fazla işlemde %99 memnuniyet oranı yakaladık. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								...
								<p>Listemizde olmayan kitapları mesaj atarsanız 3 gün içinde tedarik ederiz. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
					</div> <!-- /.row -->
				</div> <!-- /.container -->
